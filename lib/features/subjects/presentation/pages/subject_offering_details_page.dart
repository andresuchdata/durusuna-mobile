        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              // Get subject-specific updates only
              ...
              // If there's an error or no updates, show empty state
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          subjectUpdatesState.error != null
                              ? 'Failed to load updates for this subject'
                        ...
                        if (subjectUpdatesState.error != null) ...[
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              ref
                                  .read(subjectUpdatesProvider(subjectParams)
                                      .notifier)
